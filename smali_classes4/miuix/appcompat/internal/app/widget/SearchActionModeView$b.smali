...
.method public final a(Z)V
    ...
    iget-object p1, v2, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->f0:Lmiuix/view/i$a;
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;

    if-eqz p1, :cond_1

    invoke-interface {p1, v1, v1}, Lpl/b;->a(II)V

    :cond_1
    invoke-virtual {v2, v0}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->setContentViewTranslation(F)V

    iget p1, v2, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->O:I

    iget v0, v2, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->P:I

    invoke-virtual {v2, p1, v0}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->a(II)V
    ...
    iget-boolean v3, p1, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m:Z

    const/4 v4, 0x1

    if-eq v3, v4, :cond_4

    iput-boolean v4, p1, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m:Z
    ...
    invoke-interface {p1, v0, v1}, Lpl/b;->a(II)V
    ...
    invoke-virtual {v2, v0, v1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->a(II)V
    ...
    invoke-virtual {v2, p1, v1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->a(II)V
    ...
    iget-object p0, v2, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->b0:Landroid/view/View;
...
.method public final e(FZ)V
    ...
    iget-object v2, v1, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->b0:Landroid/view/View;
    ...
    iget-object p2, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;

    invoke-interface {p0, v2, v3}, Lpl/b;->a(II)V
    ...
    :cond_4
    :goto_0
    iget-object p0, v1, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->f0:Lmiuix/view/i$a;
...
.method public final g(Z)V
    ...
    :cond_3
    instance-of v1, v2, Lpl/b;

    if-eqz v1, :cond_4

    check-cast v2, Lpl/b;

    iput-object v2, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;

    :cond_4
    iget v1, v0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->k0:I
    ...
    iput v1, v0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->k0:I
    ...
    iget-object v3, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;

    if-eqz v3, :cond_9

    invoke-interface {v3}, Lpl/b;->getNestedScrollableValue()I
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView$b;->i:Lpl/b;
    ...
    iget v3, v0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->k0:I
    ...
    invoke-virtual {v0, p0, v1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->a(II)V

    goto :goto_6

    :cond_11
    iget-object p1, v0, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->f0:Lmiuix/view/i$a;
    ...
    iget-boolean v2, p1, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m:Z

    if-eqz v2, :cond_12

    iput-boolean v1, p1, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->m:Z
    ...
    invoke-interface {p0, v1, v1}, Lpl/b;->a(II)V

    invoke-virtual {v0, v1, v1}, Lmiuix/appcompat/internal/app/widget/SearchActionModeView;->a(II)V
