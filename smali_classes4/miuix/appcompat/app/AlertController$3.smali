...
.method public onClick(Landroid/view/View;)V
    ...
    sget v0, Lmiuix/view/f;->g:I

    iget-object v1, p0, Lmiuix/appcompat/app/AlertController$3;->this$0:Lmiuix/appcompat/app/AlertController;

    iget-object v2, v1, Lmiuix/appcompat/app/AlertController;->y:Landroid/widget/Button;

    const/4 v3, 0x0

    if-ne p1, v2, :cond_1

    iget-object v0, v1, Lmiuix/appcompat/app/AlertController;->A:Landroid/os/Message;
    ...
    :cond_1
    iget-object v2, v1, Lmiuix/appcompat/app/AlertController;->B:Landroid/widget/Button;

    if-ne p1, v2, :cond_2

    iget-object v1, v1, Lmiuix/appcompat/app/AlertController;->D:Landroid/os/Message;
    ...
    :cond_2
    iget-object v2, v1, Lmiuix/appcompat/app/AlertController;->E:Landroid/widget/Button;

    if-ne p1, v2, :cond_3

    iget-object v1, v1, Lmiuix/appcompat/app/AlertController;->G:Landroid/os/Message;
    ...
    :cond_3
    iget-object v1, v1, Lmiuix/appcompat/app/AlertController;->H:Ljava/util/List;
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/AlertController;->a0:Landroid/os/Handler;
