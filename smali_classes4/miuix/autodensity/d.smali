...
.method public onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;Lnl/i;)V
    .locals 0

    invoke-static {p2, p3}, Lnl/a;->i(Landroid/content/res/Configuration;Lnl/i;)V

    invoke-static {p1, p3}, Lnl/a;->g(Landroid/content/Context;Lnl/i;)V

    invoke-static {}, Lnl/a;->e()V

    const/4 p0, 0x1

    iput-boolean p0, p3, Lnl/i;->b:Z

    iput-boolean p0, p3, Lnl/i;->a:Z
...
.method public registerCallback(Landroid/app/Activity;)V
    ...
    iget-object p0, p0, Lmiuix/autodensity/d;->mUiHandler:Landroid/os/Handler;
...
.method public unregisterCallback(Landroid/app/Activity;)V
    ...
    iget-object v2, v1, Lmiuix/autodensity/d$a;->b:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    iget-object p1, v1, Lmiuix/autodensity/d$a;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_1
    iget-object p1, v1, Lmiuix/autodensity/d$a;->b:Ljava/lang/ref/WeakReference;
...
.method public unregisterDisplayListener(Lmiuix/autodensity/d$a;)V
    .locals 0

    iget-object p0, p0, Lmiuix/autodensity/d;->mDisplayManager:Landroid/hardware/display/DisplayManager;
