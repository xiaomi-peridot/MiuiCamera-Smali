...
.method private onEnd(Lmiuix/animation/internal/TransitionInfo;I)V
    ...
    invoke-static {v0, v2, v3, p2, v4}, Landroidx/activity/result/c;->l(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
...
.method private onStart(Lmiuix/animation/internal/TransitionInfo;)V
    ...
    iget-boolean v0, p1, Lmiuix/animation/internal/TransitionInfo;->hasNotifyStart:Z
    ...
    const-string v0, ">>> onStart, warning!! this transition has notified start: info.id = "
    ...
    const-string v3, ">>> onStart, info.id = "
    ...
    const-string v2, ", mRunningInfo.contains = "
    ...
    iget-object v2, v2, Lmiuix/animation/internal/AnimManager;->mRunningInfo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-boolean p0, p1, Lmiuix/animation/internal/TransitionInfo;->hasNotifyStart:Z
...
.method private update(ZLmiuix/animation/internal/TransitionInfo;)V
    ...
    .line 12
    iget-boolean v1, p2, Lmiuix/animation/internal/TransitionInfo;->hasNotifyStart:Z

    if-nez v1, :cond_2

    .line 13
    invoke-direct {p0, p2}, Lmiuix/animation/internal/TargetHandler;->onStart(Lmiuix/animation/internal/TransitionInfo;)V
    ...
    invoke-static {p0, v1, p2, v0, p1}, Lmiuix/animation/internal/TargetHandler;->setValueAndNotify(Lmiuix/animation/IAnimTarget;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/List;Z)V

    goto :goto_1

    .line 15
    :cond_3
    iget-boolean v0, p2, Lmiuix/animation/internal/TransitionInfo;->hasNotifyStart:Z
...
.method public sendStartMsg(Lmiuix/animation/internal/TransitionInfo;)V
    .locals 1
