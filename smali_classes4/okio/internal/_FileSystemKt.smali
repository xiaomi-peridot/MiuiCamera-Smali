...
# direct methods
.method public static final collectRecursively(Llk/i;Lokio/FileSystem;Lvj/f;Lokio/Path;ZZLyj/d;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v4, v3}, Lokio/internal/_FileSystemKt$collectRecursively$1;-><init>(Lyj/d;)V

    :goto_0
    iget-object v3, v4, Lokio/internal/_FileSystemKt$collectRecursively$1;->result:Ljava/lang/Object;

    sget-object v5, Lzj/a;->a:Lzj/a;
    ...
    invoke-static {v3}, La0/d;->u(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v4}, Llk/i;->a(Ljava/lang/Object;Lyj/d;)V
    ...
    invoke-virtual {v6, v13}, Lvj/f;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {v6, v13}, Lvj/f;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/_FileSystemKt;->collectRecursively(Llk/i;Lokio/FileSystem;Lvj/f;Lokio/Path;ZZLyj/d;)Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v11}, Lvj/f;->removeLast()Ljava/lang/Object;
    ...
    :goto_7
    invoke-virtual {v6}, Lvj/f;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Llk/i;->a(Ljava/lang/Object;Lyj/d;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :cond_3
    invoke-static {v0, p1}, Lcom/android/camera/effect/b;->d(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lvj/f;->addFirst(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lvj/f;->isEmpty()Z
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/_FileSystemKt$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lyj/d;)V

    new-instance p1, Llk/h;

    invoke-direct {p1}, Llk/h;-><init>()V

    invoke-static {p1, p1, v0}, Lpd/z;->h(Ljava/lang/Object;Lyj/d;Lfk/p;)Lyj/d;

    move-result-object v0

    iput-object v0, p1, Llk/h;->d:Lyj/d;

    :goto_0
    invoke-virtual {p1}, Llk/h;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Llk/h;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Llk/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/_FileSystemKt$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLyj/d;)V
