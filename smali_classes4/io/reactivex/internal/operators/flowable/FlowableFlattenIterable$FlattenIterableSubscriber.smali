...
# direct methods
.method public constructor <init>(Ljo/c;Lio/reactivex/functions/Function;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ljo/c;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ljo/d;
...
.method public checkTerminated(ZZLjo/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p1}, Ljo/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3}, Ljo/c;->onComplete()V
...
.method public consumedOne(Z)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ljo/d;
...
.method public drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ljo/c;
    ...
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLjo/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ljo/d;
    ...
    invoke-interface {v2, v0}, Ljo/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ljo/d;
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLjo/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    invoke-interface {v2, v5}, Ljo/c;->onNext(Ljava/lang/Object;)V

    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLjo/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    :goto_6
    invoke-virtual {v1, v5, v8, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLjo/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
...
.method public onSubscribe(Ljo/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ljo/d;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ljo/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ljo/c;

    invoke-interface {v0, p0}, Ljo/c;->onSubscribe(Ljo/d;)V
