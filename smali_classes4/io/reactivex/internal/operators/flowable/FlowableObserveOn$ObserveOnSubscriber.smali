...
# direct methods
.method public constructor <init>(Ljo/c;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Ljo/c;
...
.method public onSubscribe(Ljo/d;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Ljo/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Ljo/c;
...
.method public runAsync()V
    ...
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLjo/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v10}, Ljo/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ljo/d;

    invoke-interface {v8, v2, v3}, Ljo/d;->request(J)V
    ...
    invoke-interface {v0, v2}, Ljo/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLjo/c;)Z
...
.method public runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Ljo/c;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Ljo/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Ljo/c;

    invoke-interface {v1, v0}, Ljo/c;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    :cond_2
    invoke-interface {v0, v8}, Ljo/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v1}, Ljo/c;->onError(Ljava/lang/Throwable;)V
