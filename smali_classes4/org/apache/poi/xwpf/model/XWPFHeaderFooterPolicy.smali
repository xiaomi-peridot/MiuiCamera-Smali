...
.method private commit(Lorg/apache/poi/xwpf/usermodel/XWPFHeaderFooter;)Lorg/apache/xmlbeans/XmlOptions;
    ...
    invoke-static {p1, v0, v1, v2}, Landroid/support/v4/media/a;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, Lro/c;->D:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, Lro/c;->i()Lro/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Lro/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, Lro/e;->f()V

    invoke-interface {p0}, Lro/e;->a()V

    invoke-interface {p0}, Lro/e;->m()V

    invoke-interface {p0}, Lro/e;->n()V

    invoke-interface {p0}, Lro/e;->d()Lro/b;
