...
.field private transient reflected:Lkk/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lkk/b;

    move-result-object p0

    invoke-interface {p0, p1}, Lkk/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Lkk/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lkk/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lkk/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lkk/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lkk/b;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Lkk/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, Lkk/a;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lkk/b;->getParameters()Ljava/util/List;
...
.method public getReflected()Lkk/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Lkk/b;
...
.method public getReturnType()Lkk/j;
    .locals 0
    ...
    invoke-interface {p0}, Lkk/b;->getReturnType()Lkk/j;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lkk/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lkk/k;
    .locals 0
    ...
    invoke-interface {p0}, Lkk/b;->getVisibility()Lkk/k;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, Lkk/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, Lkk/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, Lkk/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {p0}, Lkk/b;->isSuspend()Z
