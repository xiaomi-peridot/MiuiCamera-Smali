...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, p1}, Lul/b;-><init>(Landroid/graphics/drawable/Drawable;)V

    const/4 p1, 0x0

    iput-boolean p1, p0, Lum/a;->m:Z

    iput-boolean p1, p0, Lum/a;->n:Z

    iput-boolean p1, p0, Lum/a;->o:Z
...
# virtual methods
.method public final c(Landroid/graphics/Canvas;IIIIZZZZ)V
    .locals 3
    ...
    iget v1, p0, Lum/a;->h:I

    goto :goto_0

    :cond_0
    iget v1, p0, Lum/a;->g:I

    :goto_0
    if-eqz p9, :cond_1

    iget p9, p0, Lum/a;->g:I

    goto :goto_1

    :cond_1
    iget p9, p0, Lum/a;->h:I
    ...
    iget-object p3, p0, Lum/a;->d:Landroid/graphics/Paint;
    ...
    iget-object p4, p0, Lum/a;->d:Landroid/graphics/Paint;
    ...
    iget-object p0, p0, Lum/a;->d:Landroid/graphics/Paint;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-super {p0, p1}, Lul/a;->draw(Landroid/graphics/Canvas;)V

    iget-boolean v0, p0, Lum/a;->o:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lum/a;->d:Landroid/graphics/Paint;

    if-eqz v0, :cond_1

    iget v0, p0, Lum/a;->j:I

    if-nez v0, :cond_0

    iget v0, p0, Lum/a;->k:I
    ...
    iget v2, p0, Lum/a;->j:I

    iget v5, v10, Landroid/graphics/Rect;->top:I

    iget v0, p0, Lum/a;->e:I

    sub-int v3, v5, v0

    iget v4, p0, Lum/a;->k:I
    ...
    iget-boolean v9, p0, Lum/a;->l:Z

    move-object v0, p0

    move-object v1, p1

    invoke-virtual/range {v0 .. v9}, Lum/a;->c(Landroid/graphics/Canvas;IIIIZZZZ)V
    ...
    iget-boolean v6, p0, Lum/a;->m:Z

    iget-boolean v7, p0, Lum/a;->n:Z
