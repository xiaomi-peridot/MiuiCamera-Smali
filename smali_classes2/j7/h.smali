...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lj7/h;->b:Ljava/util/HashMap;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    sput-object v2, Lj7/h;->c:Ljava/util/HashMap;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    sput-object v3, Lj7/h;->d:Ljava/util/HashMap;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    sput-object v4, Lj7/h;->e:Ljava/util/HashMap;

    new-instance v5, Ljava/util/HashMap;

    invoke-direct {v5}, Ljava/util/HashMap;-><init>()V

    sput-object v5, Lj7/h;->f:Ljava/util/HashMap;

    new-instance v6, Ljava/util/HashMap;

    invoke-direct {v6}, Ljava/util/HashMap;-><init>()V

    sput-object v6, Lj7/h;->g:Ljava/util/HashMap;
    ...
    const-string v7, "user_define_watermark_key"
    ...
    const-string v8, "attr_flaw_tip"

    invoke-virtual {v1, v7, v8}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v7, "pref_lens_dirty_tip"

    const-string v8, "attr_lens_dirty_switch"
    ...
    const-string v7, "pref_camera_snap_key"

    const-string v8, "attr_snap_enable"
    ...
    const-string v7, "pref_camera_normal_wide_ldc_key"

    const-string v8, "attr_normal_wide_ldc"
    ...
    const-string v7, "pref_camera_track_focus_preferred_key"
    ...
    iget-object v0, v7, Leb/a;->k:L巴巸巺嶹巺巾嶹巳已巡巾巴已嶹巔巸巺巺巸巹;
