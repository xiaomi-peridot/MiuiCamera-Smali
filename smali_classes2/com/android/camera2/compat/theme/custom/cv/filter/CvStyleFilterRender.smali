...
.method public constructor <init>(Lcom/android/gallery3d/ui/g;ILl2/f;Landroid/content/Context;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Ll2/f;
...
.method private updateVertexData(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/camera/effect/y;->h(FF)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/camera/effect/y;->f(FF)V
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/y;->a()[F
    ...
    iget-object v5, v0, Lcom/android/camera/effect/y;->e:[F
...
.method public draw(Lg2/b;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Ll2/f;
    ...
    iget v0, p1, Lg2/g;->c:I

    iget-object p1, p1, Lg2/g;->b:Landroid/graphics/Rect;
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Ll2/f;

    invoke-virtual {p0, p1, p2, v0, p3}, Ll2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public drawTexture(Lcom/android/gallery3d/ui/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 9
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Ll2/f;
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, Ll2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public initFilter(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Ll2/f;->a(Landroid/content/Context;)V
...
.method public releaseFilter()V
    ...
    iput-boolean v0, p0, Ll2/f;->h:Z

    iget v1, p0, Ll2/f;->d:I
