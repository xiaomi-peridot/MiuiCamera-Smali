...
# direct methods
.method public constructor <init>(Lqh/e;Lqh/f;)V
    .locals 0

    iput-object p1, p0, Lqh/a;->a:Lqh/e;

    iput-object p2, p0, Lqh/a;->b:Lqh/f;
...
.method public final onRecordSuccess(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lqh/a;->a:Lqh/e;

    if-nez p1, :cond_0

    const-string v1, "PhotoRecordHelper   Bitmap is null"

    invoke-interface {p2, v1}, Lqh/e;->onError(Ljava/lang/String;)V

    :cond_0
    iget-object p0, p0, Lqh/a;->b:Lqh/f;

    iget-object v1, p0, Lqh/f;->d:Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Landroidx/appcompat/widget/a;->d(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v3, v0, p1}, Lda/g;->A(ILjava/lang/String;Ljava/lang/String;)V
    :try_end_4
    ...
    :catch_5
    :cond_3
    iget-object p0, p0, Lqh/f;->d:Ljava/lang/String;

    invoke-interface {p2, p0}, Lqh/e;->b(Ljava/lang/String;)V
