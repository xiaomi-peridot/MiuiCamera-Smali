...
.field public final t:Lmiuix/animation/utils/VelocityMonitor;


# direct methods
.method public constructor <init>(Landroidx/cardview/widget/CardView;Landroid/content/Context;Z)V
    .locals 2
    ...
    iput-object p1, p0, Lmf/c;->r:Landroid/view/View;

    iput-boolean p3, p0, Lmf/c;->o:Z
...
.method public final declared-synchronized a(FII)V
    ...
    iput v0, v1, Lmf/c;->p:F

    iput v2, v1, Lmf/c;->m:I

    iput v3, v1, Lmf/c;->n:I

    iget-object v2, v1, Lmf/c;->s:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, Lmf/c;->s:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    iget-object v6, v1, Lmf/c;->q:Landroid/util/Size;

    invoke-virtual {v6}, Landroid/util/Size;->getWidth()I

    move-result v6

    iget-object v7, v1, Lmf/c;->q:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getHeight()I

    move-result v7

    iget v9, v1, Lmf/c;->n:I
    ...
    :cond_4
    iput v11, v1, Lmf/c;->e:I

    iput v8, v1, Lmf/c;->i:I

    iput v10, v1, Lmf/c;->h:I
    ...
    iget-object v8, v1, Lmf/c;->b:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v8

    const v11, 0x7f070fe8
    ...
    :cond_8
    iput v2, v1, Lmf/c;->e:I

    sget-boolean v2, Lh1/a;->m:Z

    if-eqz v2, :cond_9

    iget-object v2, v1, Lmf/c;->b:Landroid/content/Context;
    ...
    iput v0, v1, Lmf/c;->i:I

    :goto_7
    iget v0, v1, Lmf/c;->d:I

    iget v2, v1, Lmf/c;->e:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, Lmf/c;->f:I

    iget v0, v1, Lmf/c;->h:I

    iget v2, v1, Lmf/c;->i:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, Lmf/c;->j:I
