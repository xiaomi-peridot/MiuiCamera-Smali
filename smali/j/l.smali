...
.method public constructor <init>(Lo/g;)V
    ...
    iput-object v0, p0, Lj/l;->d:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, Lj/l;->e:Lo/g;
...
.method public final b(Ljava/util/ListIterator;)V
    ...
    iget-object v1, p0, Lj/l;->d:Ljava/util/ArrayList;
...
.method public final d(Landroid/graphics/Path$Op;)V
    ...
    iget-object v2, p0, Lj/l;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lj/d;->b()Ljava/util/List;
    ...
    invoke-interface {v8}, Lj/m;->getPath()Landroid/graphics/Path;

    move-result-object v8

    iget-object v9, v5, Lj/d;->k:Lk/o;

    if-eqz v9, :cond_0

    invoke-virtual {v9}, Lk/o;->d()Landroid/graphics/Matrix;
    ...
    :cond_0
    iget-object v9, v5, Lj/d;->c:Landroid/graphics/Matrix;
    ...
    instance-of v4, v2, Lj/d;

    if-eqz v4, :cond_5

    check-cast v2, Lj/d;

    invoke-virtual {v2}, Lj/d;->b()Ljava/util/List;
    ...
    iget-object v6, v2, Lj/d;->k:Lk/o;

    if-eqz v6, :cond_4

    invoke-virtual {v6}, Lk/o;->d()Landroid/graphics/Matrix;
    ...
    :cond_4
    iget-object v6, v2, Lj/d;->c:Landroid/graphics/Matrix;
...
.method public final e(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v1, p1, p2}, Lj/c;->e(Ljava/util/List;Ljava/util/List;)V
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-object v1, p0, Lj/l;->e:Lo/g;

    iget-boolean v2, v1, Lo/g;->b:Z
    ...
    invoke-virtual {p0, v1}, Lj/l;->d(Landroid/graphics/Path$Op;)V
