...
.method public static a(Lorg/xmlpull/v1/XmlSerializer;JII)V
    ...
    sget-object p2, Lp5/b;->a:Ljava/lang/String;
...
.method public static b(Ljava/lang/String;)Lp5/a;
    .locals 9
...
.method public static c(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    sget-object v0, Lp5/b;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lp5/b;->g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    move-result-object v6
    :try_end_0
    .catch Lc/c; {:try_start_0 .. :try_end_0} :catch_3

    :try_start_1
    invoke-virtual {v6}, Ld/l;->c()Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lp5/b;->b(Ljava/lang/String;)Lp5/a;
    ...
    .catch Lc/c; {:try_start_3 .. :try_end_3} :catch_3
    ...
    .catch Lc/c; {:try_start_5 .. :try_end_5} :catch_3
    ...
    .catch Lc/c; {:try_start_7 .. :try_end_7} :catch_3
    ...
    :try_end_8
    .catch Lc/c; {:try_start_8 .. :try_end_8} :catch_3
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)[B
    ...
    invoke-static {p0}, Lp5/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v2, v1}, Lp5/b;->i(I[B)Ljava/util/ArrayList;
...
.method public static h(Ljava/io/File;Lp5/c;[B[B)V
    .locals 16
    ...
    invoke-static {v9}, Lp5/b;->e(Ljava/io/InputStream;)S
    ...
    invoke-static {v13, v6}, Lp5/b;->i(I[B)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v7, v4, v1}, Lp5/b;->k(Ljava/util/ArrayList;I[BLp5/c;)V
    ...
    invoke-static {v6, v1}, Lp5/b;->j(Ljava/util/ArrayList;Lp5/c;)V
    ...
    invoke-static {v0}, Lp5/b;->f(S)[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/FileOutputStream;->write([B)V

    invoke-static {v1, v6}, Lp5/b;->l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
...
.method public static i(I[B)Ljava/util/ArrayList;
    ...
    iput v3, v2, Lp5/c;->a:I

    invoke-virtual {p1}, Ljava/nio/ByteBuffer;->getShort()S

    move-result v3

    iput v3, v2, Lp5/c;->b:I
...
.method public static j(Ljava/util/ArrayList;Lp5/c;)V
    .locals 6
    ...
    iget v2, v1, Lp5/c;->d:I

    invoke-virtual {p1}, Lp5/c;->a()I
    ...
    iput v3, v1, Lp5/c;->d:I

    goto :goto_0

    :cond_1
    invoke-virtual {v1}, Lp5/c;->a()I
    ...
    invoke-static {p0, v0}, Landroidx/concurrent/futures/a;->c(Ljava/util/ArrayList;I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lp5/c;

    invoke-virtual {v0}, Lp5/c;->a()I
...
.method public static k(Ljava/util/ArrayList;I[BLp5/c;)V
    .locals 4
    ...
    invoke-static {p1, p0, v1, v0}, Landroidx/core/content/v;->f(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
...
.method public static l(Ljava/io/FileOutputStream;Ljava/util/ArrayList;)V
    ...
    iget v1, v0, Lp5/c;->a:I

    int-to-short v1, v1

    invoke-static {v1}, Lp5/b;->f(S)[B

    move-result-object v1

    invoke-virtual {p0, v1}, Ljava/io/FileOutputStream;->write([B)V

    iget v1, v0, Lp5/c;->b:I
    ...
    iget v1, v0, Lp5/c;->c:I

    invoke-static {v1}, Lp5/b;->d(I)[B
