...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILfk/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lvj/n;->R(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lfk/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILfk/l;)V
    ...
    invoke-static {p2}, Ld/e;->r(Ljava/util/List;)I
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILfk/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILfk/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lfk/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lfk/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v7}, Lvj/l;->H(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, Lj7/c;->e(Lwj/f;)Lwj/f;

    new-instance v4, Lwj/a;

    invoke-direct {v4}, Lwj/a;-><init>()V
    ...
    invoke-virtual {v2, v9}, Lwj/f;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v11}, Lwj/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, Ld/e;->j(Lwj/a;)Lwj/a;
    ...
    invoke-direct {v10, v4, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lfk/q;)V
    ...
    new-instance v13, Lwj/a;

    invoke-direct {v13}, Lwj/a;-><init>()V

    invoke-virtual {v4}, Lwj/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lwj/a$a;

    invoke-virtual {v15}, Lwj/a$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lwj/a$a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v5}, Lwj/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Ld/e;->j(Lwj/a;)Lwj/a;

    invoke-virtual {v13}, Lwj/a;->isEmpty()Z
    ...
    invoke-static {v0, v11, v1}, Landroidx/activity/result/c;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILfk/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILfk/l;ILjava/lang/Object;)V
