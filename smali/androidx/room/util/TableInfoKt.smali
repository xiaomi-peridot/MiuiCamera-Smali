...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    sget-object v0, Lvj/q;->a:Lvj/q;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v2, v4}, La0/d;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    new-instance v9, Lwj/b;

    invoke-direct {v9}, Lwj/b;-><init>()V
    ...
    invoke-virtual {v9, v10, v11}, Lwj/b;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v9}, Lwj/b;->b()V

    iput-boolean v11, v9, Lwj/b;->l:Z
    :try_end_1
    ...
    invoke-static {v2, v1}, La0/d;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lwj/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v4}, Lvj/n;->R(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v4, p0}, Lwj/a;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v5, v6}, Lwj/f;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_5
    invoke-static {v5}, Lj7/c;->e(Lwj/f;)Lwj/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {v0}, Lvj/n;->R(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, La0/d;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v5}, La0/d;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v5

    :cond_3
    :try_start_1
    invoke-virtual {v4, v6}, Lwj/f;->add(Ljava/lang/Object;)Z

    goto :goto_0

    :cond_4
    invoke-static {v4}, Lj7/c;->e(Lwj/f;)Lwj/f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
