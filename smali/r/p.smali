...
.method public static a(Ls/c;)I
    ...
    :goto_0
    invoke-virtual {p0}, Ls/c;->e()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p0}, Ls/c;->n()V
...
.method public static b(Ls/c;F)Landroid/graphics/PointF;
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/b;->j(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Ls/c;->l(Ls/c$a;)I
    ...
    :cond_3
    invoke-static {p0}, Lr/p;->d(Ls/c;)F
...
.method public static c(Ls/c;F)Ljava/util/ArrayList;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static d(Ls/c;)F
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/b;->j(I)Ljava/lang/String;
