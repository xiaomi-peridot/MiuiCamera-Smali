...
.method public final a(Ls/c;F)Ljava/lang/Object;
    ...
    sget-object v5, Lr/b0;->b:Ls/c$a;

    invoke-virtual {p1, v5}, Ls/c;->l(Ls/c$a;)I
    ...
    :cond_1
    invoke-static {p1, p2}, Lr/p;->c(Ls/c;F)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p1, v1, p2}, Lo/k;-><init>(Landroid/graphics/PointF;ZLjava/util/List;)V
    ...
    invoke-static {v9, v8}, Lt/f;->a(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object v8

    invoke-static {v7, v10}, Lt/f;->a(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {p0, p1}, Lt/f;->a(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;

    move-result-object p0

    invoke-static {v6, v0}, Lt/f;->a(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-direct {p0, p2, v4, v5}, Lo/k;-><init>(Landroid/graphics/PointF;ZLjava/util/List;)V
