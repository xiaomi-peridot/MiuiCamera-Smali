...
.method public final a()Lh/o;
    ...
    :cond_0
    invoke-virtual {p0, v1}, Lq/c;->c(Ljava/net/HttpURLConnection;)Lh/o;
    ...
    :goto_0
    :try_start_1
    invoke-static {v1}, Lq/c;->b(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    invoke-direct {v3, v4}, Lh/o;-><init>(Ljava/lang/Throwable;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method public final c(Ljava/net/HttpURLConnection;)Lh/o;
    .locals 4
    ...
    iget-object v1, p0, Lq/c;->a:Ljava/lang/String;

    iget-object p0, p0, Lq/c;->b:Lq/b;
    ...
    invoke-virtual {p0, p1, v0}, Lq/b;->b(Ljava/io/InputStream;Lq/a;)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v2, v1}, Lh/e;->e(Ljava/util/zip/ZipInputStream;Ljava/lang/String;)Lh/o;

    move-result-object p1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v2}, Lt/g;->b(Ljava/io/Closeable;)V
    ...
    invoke-static {v2, v1}, Lh/e;->b(Ljava/io/InputStream;Ljava/lang/String;)Lh/o;

    move-result-object p1

    :goto_0
    iget-object v1, p1, Lh/o;->a:Ljava/lang/Object;
    ...
    invoke-static {v1, v0, v2}, Lq/b;->a(Ljava/lang/String;Lq/a;Z)Ljava/lang/String;

    move-result-object v0

    new-instance v1, Ljava/io/File;

    iget-object p0, p0, Lq/b;->a:Landroid/content/Context;
