...
.method public constructor <init>(Landroid/widget/FrameLayout;Ly/a;)V
    ...
    iput-object v0, p0, Ld0/p;->d:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Ld0/p;->a:Landroid/view/View;

    if-nez v0, :cond_0

    invoke-interface {p0}, Ld0/e;->getId()I
    ...
    iput-object p1, p0, Ld0/p;->a:Landroid/view/View;

    :cond_0
    iget-object p1, p0, Ld0/p;->a:Landroid/view/View;
    ...
    iput-object p1, p0, Ld0/p;->b:Landroid/view/ViewGroup;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iput-object p1, p0, Ld0/p;->i:Ljava/lang/StringBuilder;
...
# virtual methods
.method public a(FILandroid/graphics/Rect;Lb0/r;)Landroid/widget/FrameLayout$LayoutParams;
    .locals 0
...
.method public c(Lb0/r;FIZ)V
    .locals 6

    iget-object v1, p0, Ld0/p;->a:Landroid/view/View;

    iget-object p3, p0, Ld0/p;->d:Landroid/graphics/Rect;
...
.method public g(Lb0/r;)V
    .locals 1

    iget-object p1, p0, Ld0/p;->a:Landroid/view/View;

    iget-object v0, p0, Ld0/p;->i:Ljava/lang/StringBuilder;

    invoke-virtual {p1, v0}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object p0, p0, Ld0/p;->i:Ljava/lang/StringBuilder;
...
.method public h(FILandroid/graphics/Rect;Lb0/r;)V
    .locals 7

    iget-object p1, p0, Ld0/p;->a:Landroid/view/View;

    iget-object p4, p0, Ld0/p;->b:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v0, p0, Ld0/p;->c:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Ld0/p;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Ld0/p;->c:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Ld0/p;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p3, p1, v0}, Ld0/p;->l(Landroid/graphics/Rect;ILandroid/util/Size;)V
...
.method public final k(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Ld0/p;->i:Ljava/lang/StringBuilder;
